...
namespace MagicMirrorWorker
{
    public class Startup
    {
        ...
        {
            services.Configure<OpenWeatherApiOptions>(Configuration.GetSection(OpenWeatherApiOptions.Position));
            services.AddHttpClient<IOpenWeatheHttpClient, OpenWeatheHttpClient>("open_weather");
